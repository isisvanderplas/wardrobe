...
item_7 = ClothesItem.create!( {closet: izzie, name:"reversible dress, multi-use purpose", style:"top", season:"winter", image_url:"https://i.imgur.com/SKfKkFZ.gif", in_use: true, description:"LOOK AT IT"})
item_8 = ClothesItem.create!( {closet: izzie, name:"Battle Jacket \m/", style:"top", season:"all-year", image_url:"https://i.pinimg.com/736x/a0/f5/76/a0f576ade07fee6341f331ec58c3445a--leather-pants-leather-jackets.jpg", in_use: false, description:"DON'T FUCK WITH ME APPLEBOTTOM-BITCHESSSSS"})
